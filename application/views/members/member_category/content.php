                    ...
                    <div class="container-fluid">
                        ...
                        <div class="page-title-box">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h6 class="page-title">Member Catagory</h6>
                                    ...
                                    <div class="card-body">
                                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><?= $i++;?></td>
                                                    <td><a href="<?= admin_url('category/edit/'.$item->id);?>"><?= $item->name;?></a></td>
                                                    ...
                                                    <td>
                                                        ...
                                                        ?>
                                                        <a href="<?= admin_url('category/edit/'.$item->id);?>" class="btn btn-primary btn-sm edit" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit this Item">
                                                        ...
                                                        ?>
                                                        <a class="btn btn-danger btn-sm edit" onclick="confirmDelete(this.id,'category');" data-bs-toggle="tooltip" data-bs-placement="top" title="Remove this Item" id="<?= $item->id;?>">
