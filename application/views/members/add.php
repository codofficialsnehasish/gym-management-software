                        ...
                        <div class="row">
                            ...
                            <!-- <fieldset class="form-group border p-3 mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control" name="zip_code" id="validationCustom03">
                                        <div class="invalid-feedback">
                                            This field is required
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control" id="validationCustom03" name="address"><?= !empty($inquiry_data) ? $inquiry_data->address : '' ?></textarea>
                                    <div class="invalid-feedback">
                                        This field is required
                                    </div>
                                </div>
                            ...
                            <fieldset class="form-group border p-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <label for="validationCustom03" class="form-label">Pin Code</label>
                                        <input type="text" class="form-control" name="pn_zip_code" id="validationCustom03">
                                        <div class="invalid-feedback">
                                            This field is required
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <label for="validationCustom03" class="form-label">Address</label>
                                    <textarea class="form-control" id="validationCustom03" name="pn_address"><?= !empty($inquiry_data) ? $inquiry_data->address : '' ?></textarea>
                                    <div class="invalid-feedback">
                                        This field is required
                                    </div>
                                </div>
