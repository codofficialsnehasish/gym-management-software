                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select" name="member_id" id="member">
                            ...
                            <div class="col-md-4 mb-3">
                                <input class="form-check-input" type="checkbox" value="" id="is-continue-charge">
                                <label class="form-check-label" for="is-continue-charge">
                                    Add Continue Charge?
                                </label>
                                <select class="form-select mt-2" id="continueChargeSection" name="package_id" style="display: none;" required>
