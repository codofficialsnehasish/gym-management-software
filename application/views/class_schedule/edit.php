<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- end page title -->
        <?= form_open_multipart('gym-c-info/update-process/'.$item->id, 'class="custom-validation"');?>
        <div class="row">
            <div class="col-lg-9">
                <div class="card">
                    <div class="card-header bg-primary text-light">Edit Class</div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    <label for="class_name" class="form-label">Class Name</label>
                                    <input type="text" class="form-control disbld" name="class_name" value="<?= $item->class_name ?>" id="class_name" required>
                                </div>
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select class="form-select" name="trainer_id" id="trainer_id" required>
                                        ...
                                        ?>
                                        <option value="<?= $trainer->id; ?>" <?php if($item->trainer_id == $trainer->id) { echo "selected"; } ?>><?= $trainer->full_name;?></option>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="time" class="form-control disbld" name="start_time" value="<?= $item->start_time ?>" id="start_time" required>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="end_time" class="form-label">End Time</label>
                                    <input type="time" class="form-control disbld" name="end_time" value="<?= $item->end_time ?>" id="end_time" required>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="capacity" class="form-label">Capacity</label>
                                    <input type="text" class="form-control disbld" name="capacity" value="<?= $item->capacity ?>" id="capacity" required>
                                </div>                  
                            </div>
                        </div>
                    </div>
