<div class="page-content">
   <div class="container-fluid">
         ...
         <div class="row align-items-center">
            <div class="col-md-8">
               ...
               <ol class="breadcrumb m-0">
                  ...
                  <li class="breadcrumb-item"><a href="<?= admin_url('continue-charge')?>">Continue Charge</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Add new Continue Charge</li>
               </ol>
            </div>
            <div class="col-md-4">
               <div class="float-end d-none d-md-block">
                  <div class="dropdown">
                     <a href="<?= admin_url('continue-charge')?>" class="btn btn-primary  dropdown-toggle" aria-expanded="false">
      ...
      <!-- end page title -->
      <?= form_open_multipart('continue-charge/process', 'class="custom-validation"');?>
      
         <div class="row">
            <div class="col-lg-9">
               <div class="card">
                  <div class="card-header bg-primary text-light">
                     Add New Continue Charge
                  </div>
                  <div class="card-body">
                     <div class="mb-3">
                     ...
                     <div class="mb-3">
                        ...
                        <div>
                           <input data-parsley-type="text" type="text"
                              class="form-control" required
                              placeholder="Enter amount" name="amount" value="" required>
                        </div>
                     </div>
                     <div class="mb-3">
                        ...
                        <div>
                           <input data-parsley-type="text" type="text"
                              class="form-control" required
                              placeholder="Enter Duration" name="duration" value="" required>
                        </div>
                     </div>
                   </div>
               </div>
