	...
	$.ajax({
		url:'<?= base_url('admin/dashboard/set-payment/')?>',
		type:'POST',
		data:{tech_id:id,pay_amount:amount,pay_date:paydate},
		dataType:'html',
		beforeSend: function() {
		$('#btn_' + id).hide();
...
function set_subscription(id){
	...
	$.ajax({
		url:'<?= base_url('admin/dashboard/set-subscription/')?>',
		type:'POST',
		data:{tech_id:id,subscribed_amount:samount,package:pack,subscribed_on:spaydate},
		dataType:'html',
		beforeSend: function() {
		$('#sbtn_' + id).hide();
...
function set_register(id){
	...
	$.ajax({
		url:'<?= base_url('admin/dashboard/set-register/')?>',
		type:'POST',
		data:{tech_id:id,register_date:register},
		dataType:'html',
		beforeSend: function() {
		$('#regrbtn_' + id).hide();
...
function set_subscribed(id){
	...
	$.ajax({
		url:'<?= base_url('admin/dashboard/set-subscribed/')?>',
		type:'POST',
		data:{tech_id:id,subscribed_on:subscribed},
		dataType:'html',
		beforeSend: function() {
...
function set_status(id){
	...
	$.ajax({
		url:'<?= base_url('admin/dashboard/set-status/')?>',
		type:'POST',
		data:{tech_id:id,tech_status:techstatus},
		dataType:'html',
		beforeSend: function() {
		$('#stsbtn_' + id).hide();
...
function gettechnicianDetails(usderid){
	const getUrl = window.location;
      const base_url = getUrl.protocol + "//" + getUrl.host + "/admin/technicians/" ;
      $.ajax({
