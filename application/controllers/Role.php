...
class Role extends Core_Controller {
	...
	{
		if ($this->permission->method('role', 'read')->access()) {
	...
	{
		if ($this->permission->method('role', 'create')->access()) {
			$header['pagecss']="";
	...
	{
		if ($this->permission->method('role', 'update')->access()) {
	...
	public function delete(){
		if ($this->permission->method('role', 'delete')->access()) {
