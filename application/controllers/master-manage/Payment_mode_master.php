...
class Payment_mode_master extends Core_Controller {
	...
	{
		if ($this->permission->method('payment_mode', 'create')->access()) {
			$header['pagecss']="";
	...
	{
		if ($this->permission->method('payment_mode', 'update')->access()) {
	...
	public function delete(){
		if ($this->permission->method('payment_mode', 'delete')->access()) {
