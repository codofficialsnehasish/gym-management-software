...
class Catagory_master extends Core_Controller {
	...
	{
		if ($this->permission->method('category_master', 'create')->access()) {
			$header['pagecss']="";
	...
	{
		if ($this->permission->method('category_master', 'update')->access()) {
	...
	public function delete(){
		if ($this->permission->method('category_master', 'delete')->access()) {
