...
class Status_master extends Core_Controller {
	...
	{
		if ($this->permission->method('status_master', 'create')->access()) {
			$header['pagecss']="";
	...
	{
		if ($this->permission->method('status_master', 'update')->access()) {
	...
	public function delete(){
		if ($this->permission->method('status_master', 'delete')->access()) {
