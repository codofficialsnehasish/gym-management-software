...
class Package_master extends Core_Controller {
	...
	{
		if ($this->permission->method('membership_plan', 'read')->access()) {
	...
	{
		if ($this->permission->method('membership_plan', 'create')->access()) {
			$header['pagecss']="";
	...
	{
		if ($this->permission->method('membership_plan', 'update')->access()) {
	...
	public function delete(){
		if ($this->permission->method('membership_plan', 'delete')->access()) {
