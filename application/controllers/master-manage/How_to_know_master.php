...
class How_to_know_master extends Core_Controller {
	...
	{
		if ($this->permission->method('how_to_know_master', 'create')->access()) {
			$header['pagecss']="";
	...
	{
		if ($this->permission->method('how_to_know_master', 'update')->access()) {
	...
	public function delete(){
		if ($this->permission->method('how_to_know_master', 'delete')->access()) {
