...
class Religion_master extends Core_Controller {
	...
	{
		if ($this->permission->method('religion_master', 'create')->access()) {
			$header['pagecss']="";
	...
	{
		if ($this->permission->method('religion_master', 'update')->access()) {
	...
	public function delete(){
		if ($this->permission->method('religion_master', 'delete')->access()) {
