...
class Blood_group_master extends Core_Controller {
	...
	public function __construct()
    {
		...
		$this->view_path='master_data_manage/blood_group_master/';
	...
	{
		if ($this->permission->method('blood_group_master', 'create')->access()) {
			$header['pagecss']="";
	...
	{
		if ($this->permission->method('blood_group_master', 'update')->access()) {
