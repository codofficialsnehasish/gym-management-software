...
class Documents extends Core_Controller {
	...
	public function __construct()
    {
		...
		$this->view_path='master_data_manage/documents/';
	...
	{
		if ($this->permission->method('documents_master', 'create')->access()) {
			$header['pagecss']="";
			$header['title']='Add New Document';
			$this->load->view('partials/header',$header);
			$data['categories']='';
	...
	{
		if ($this->permission->method('documents_master', 'update')->access()) {
	...
	public function delete(){
		if ($this->permission->method('blood_group_master', 'delete')->access()) {
