...
class Medical_history_master extends Core_Controller {
	...
	{
		if ($this->permission->method('medical_history', 'create')->access()) {
			$header['pagecss']="";
	...
	{
		if ($this->permission->method('medical_history', 'update')->access()) {
	...
	public function delete(){
		if ($this->permission->method('medical_history', 'delete')->access()) {
