...
class Gender_master extends Core_Controller {
	...
	{
		if ($this->permission->method('gender_master', 'create')->access()) {
			$header['pagecss']="";
	...
	{
		if ($this->permission->method('gender_master', 'update')->access()) {
	...
	public function delete(){
		if ($this->permission->method('gender_master', 'delete')->access()) {
