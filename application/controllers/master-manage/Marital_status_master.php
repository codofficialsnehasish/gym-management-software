...
class Marital_status_master extends Core_Controller {
	...
	{
		if ($this->permission->method('marital_status_master', 'create')->access()) {
			$header['pagecss']="";
	...
	{
		if ($this->permission->method('marital_status_master', 'update')->access()) {
	...
	public function delete(){
		if ($this->permission->method('marital_status_master', 'delete')->access()) {
