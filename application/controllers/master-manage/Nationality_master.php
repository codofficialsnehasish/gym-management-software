...
class Nationality_master extends Core_Controller {
	...
	{
		if ($this->permission->method('nationality_master', 'create')->access()) {
			$header['pagecss']="";
	...
	{
		if ($this->permission->method('nationality_master', 'update')->access()) {
	...
	public function delete(){
		if ($this->permission->method('nationality_master', 'delete')->access()) {
