...
class Shift_master extends Core_Controller {
	...
	public function __construct()
    {
		...
		$this->view_path='master_data_manage/shift_master/';
	...
	{
		if ($this->permission->method('shift_master', 'create')->access()) {
			$header['pagecss']="";
	...
	{
		if ($this->permission->method('shift_master', 'update')->access()) {
	...
	public function delete(){
		if ($this->permission->method('shift_master', 'delete')->access()) {
